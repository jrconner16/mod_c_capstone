...
- **[MISSING COMMENTARY: Add a descriptive project title.]**
- Possible structure only: *Comparing Supervised Classification and Unsupervised Clustering Across Two Cancer Datasets*
...
- **[MISSING COMMENTARY: Explain why comparing model behavior across the two datasets is useful or important.]**
...
- **[MISSING COMMENTARY: Explicitly identify the one or two topics that will receive the deepest discussion.]**
- Strong candidates based on notebook detail:
  - Gradient boosting, especially the Brazil threshold tradeoff.
  - K-means, because the notebook includes stability and representation sensitivity.
  - DBSCAN, because the notebook explicitly frames it as the primary Week 11 analysis.
- **Do not list all three as deep dives unless the final paper has enough room.**
...
- **[MISSING COMMENTARY: State the complete source and original size of the Brazil dataset.]**
- **[MISSING COMMENTARY: Explain the outcome variable in plain language and any restrictions on interpreting it.]**
...
- **[MISSING COMMENTARY: Identify any categorical-variable encoding performed before the models.]**
...
- **[MISSING COMMENTARY: Add specific EDA plots or numerical findings beyond class balance, if available elsewhere.]**
- **[MISSING COMMENTARY: State whether there were notable outliers, highly correlated variables, or missingness patterns.]**
...
- **[MISSING COMMENTARY: Add the exact random seeds and sampling sizes used in Weeks 8, 10, and 11 where relevant.]**
...
- **[MISSING RESULT: Add the exact Brazil sample size and seed used in this notebook.]**
...
- **[MISSING RESULT: Notebook is unexecuted. Insert selected k for Wisconsin.]**
- **[MISSING RESULT: Insert Wisconsin silhouette score and relevant inertia/elbow interpretation.]**
- **[MISSING RESULT: Insert selected k for Brazil.]**
- **[MISSING RESULT: Insert Brazil silhouette score and relevant inertia/elbow interpretation.]**
...
- **[MISSING RESULT: Insert Wisconsin repeated-seed ARI summary.]**
- **[MISSING RESULT: Insert Brazil repeated-seed ARI summary.]**
- **[MISSING COMMENTARY: Explain whether high stability reflects a meaningful structure or merely a consistently imposed partition.]**
...
- **[MISSING RESULT: Describe the Wisconsin PCA pattern.]**
- **[MISSING RESULT: Describe the Brazil PCA pattern.]**
...
- **[MISSING RESULT: Insert Wisconsin cluster sizes and diagnosis prevalence.]**
- **[MISSING RESULT: Insert Brazil cluster sizes and outcome prevalence.]**
- **[MISSING COMMENTARY: Explain whether observed differences were large enough to be substantively interesting.]**
...
- **[MISSING RESULT: Insert Wisconsin full-versus-reduced sensitivity results.]**
- **[MISSING RESULT: Insert Brazil full-versus-reduced sensitivity results.]**
- **[MISSING COMMENTARY: Explain what the representation sensitivity means for trust in each clustering solution.]**
...
- **[MISSING: Run notebook and export figure.]**
...
- **[MISSING RESULT: Add the DBSCAN Brazil sample size and seed.]**
...
- **[MISSING RESULT: Notebook is unexecuted. Insert selected eps.]**
- **[MISSING RESULT: Insert selected min_samples.]**
- **[MISSING RESULT: Insert number of clusters.]**
- **[MISSING RESULT: Insert noise fraction.]**
- **[MISSING RESULT: Insert non-noise silhouette.]**
- **[MISSING COMMENTARY: Describe how sensitive these values were to nearby parameter choices.]**
- **[MISSING COMMENTARY: State whether the noise observations appeared substantively unusual.]**

### Brazil results

- **[MISSING RESULT: Insert selected eps.]**
- **[MISSING RESULT: Insert selected min_samples.]**
- **[MISSING RESULT: Insert number of clusters.]**
- **[MISSING RESULT: Insert noise fraction.]**
- **[MISSING RESULT: Insert non-noise silhouette.]**
- **[MISSING COMMENTARY: Describe parameter sensitivity.]**
- **[MISSING COMMENTARY: Explain whether the solution was useful or mostly an artifact of representation and density choice.]**
...
- **[MISSING RESULT: Insert selected linkage.]**
- **[MISSING RESULT: Insert selected k.]**
- **[MISSING RESULT: Insert silhouette score.]**
- **[MISSING RESULT: Insert cluster sizes and diagnosis prevalence.]**
- **[MISSING COMMENTARY: Describe whether Ward and average linkage agreed.]**

### Brazil results

- Based on a 5,000-row sample.
- **[MISSING RESULT: Insert selected linkage.]**
- **[MISSING RESULT: Insert selected k.]**
- **[MISSING RESULT: Insert silhouette score.]**
- **[MISSING RESULT: Insert cluster sizes and outcome prevalence.]**
- **[MISSING COMMENTARY: Explain how sampling limits interpretation.]**
- **[MISSING COMMENTARY: Describe whether Ward and average linkage agreed.]**
...
- **[MISSING RESULT: State which method produced the more convincing solution for each dataset.]**
...
- **[MISSING: Run notebook and select final figure.]**
...
- **[MISSING RESULT: Numerical clustering results are unavailable because Weeks 10 and 11 were not executed in the attached notebooks.]**
- **[MISSING COMMENTARY: After running them, state whether multiple diagnostics converged on a credible cluster structure.]**
- Required caution:
...
- Wisconsin:
  ...
  - Expected to show clearer clustering, but this must be confirmed with the missing results.
- Brazil:
...
- **[MISSING COMMENTARY: Finalize which 4–6 visuals best support actual conclusions after Weeks 10 and 11 are run.]**

# 11. References

- **[MISSING: Add dataset source for Wisconsin.]**
- **[MISSING: Add dataset source for Brazil.]**
- **[MISSING: Add external KNN source.]**
- **[MISSING: Add external gradient-boosting source.]**
- **[MISSING: Add external K-means/silhouette source.]**
- **[MISSING: Add external DBSCAN source.]**
- **[MISSING: Add external hierarchical-clustering source.]**
- **[MISSING COMMENTARY: Briefly state what each external source helped you understand rather than listing sources without discussion.]**
...
- Run Weeks 10 and 11; both attached notebooks currently contain no executed outputs.
- Insert all K-means selected-k, silhouette, ARI, cluster-profile, and sensitivity results.
- Insert all DBSCAN parameter, cluster-count, noise, silhouette, and outcome-profile results.
- Insert all hierarchical linkage, k, silhouette, and outcome-profile results.
- Decide which one or two weeks are the explicit deep dives.
- Add project impact and intended audience.
- Add full dataset provenance.
- Add external model/library sources.
